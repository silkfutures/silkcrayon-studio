...
export default function AdminNav({profile}){
 ...
 return <>
  <nav className="osNav">
    ...
    <Link href="/admin/leads">Enquiries</Link><Link href="/admin/projects">Projects</Link><Link href="/admin/contacts">Contacts</Link><Link href="/admin/marketing">Marketing</Link><Link href="/admin/customers">Customers</Link><Link href="/admin/staff">Staff</Link><Link href="/admin/settings">Settings</Link><Link href="/">Website ↗</Link>
