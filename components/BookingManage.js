...
export default function BookingManage({booking,cutoffHours}){
 ...
 return <div className="manageBooking">
  <section className="managePanel">
   ...
   {pending?<div className="portalNotice"><b>Change request pending.</b><span>You requested {formatUkDate(booking.change_requested_date)} at {String(booking.change_requested_start||'').slice(0,5)}. We’ll email you once it’s approved or declined.</span></div>:<>
