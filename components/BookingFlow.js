...
export default function BookingFlow({promotions=[],pricing={}}) {
  ...
  function updateReadiness(e) {
    ...
    setDetailsReady(Boolean(fullName && email && policy && dryHirePolicy && form.elements.email?.checkValidity()));
  }
