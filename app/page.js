...
export default async function Home(){
  ...
  const services=[
    ...
    {n:'05',title:'Podcast Recording',copy:'Crystal-clear spoken-word recording with an engineer. Editing, mixing/mastering and episode finishing are separate post-production services.',meta:'Recording quoted separately · Post-production extra',href:'/enquire?type=podcast-recording',enquire:true},
    {n:'06',title:'Full Day',copy:'Eight hours in the vault for focused recording, writing, development and production without watching the clock.',meta:`${fullDay} / day`,href:'/booking?service=full-day'}
  ];
