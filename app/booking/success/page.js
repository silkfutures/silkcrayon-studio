...
export default async function Success({searchParams}){
 const {session_id}=await searchParams;let b=null,first=false,paid=false;
 if(session_id){try{
