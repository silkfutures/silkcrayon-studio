...
export default function Services(){
 return <main className="marketingSite servicesPage">
  ...
  <section className="section serviceExtras"><div className="container"><div className="sectionHeading"><div><p className="eyebrow">More ways to use the studio</p><h2>Time that fits around you.</h2></div></div><div className="serviceExtraGrid"><Link href="/buy-hours"><b>Buy studio hours</b><span>Pay now. Choose the date later →</span></Link><Link href="/gift-studio-time"><b>Gift studio time</b><span>Give 1, 2, 4 or 8 hours →</span></Link><Link href="/young-creators"><b>For young creators</b><span>Creative space, confidence and craft →</span></Link></div></div></section><section className="section finalCta"><div className="container"><Reveal><p className="eyebrow">Your next record starts here</p><h2>Ready when you are.</h2><p>Choose a session, pick a time and come make something worth keeping.</p><Link className="button primary large" href="/booking">Book Silkcrayon <span>↗</span></Link><p className="ctaMicro">From £60/hour · Secure online booking · Cardiff Bay</p></Reveal></div></section>
